<%@ Control Language="C#" AutoEventWireup="true" CodeFile="HeaderForWorkOrders.ascx.cs" Inherits="Controls_HeaderForWorkOrders" %>
            ...
            <div id="MainMenuTitleBG" style="margin: 0px; padding: 0px; width: 982px; height: 27px;
                ...
                <div align="Center">
                    ...
                    <telerik:RadMenu ID="RadMenu1" runat="server" Style="top: 0px; right: 0px">
                        <Items>
                            <telerik:RadMenuItem runat="server" Owner="RadMenu1" Text="وسائط عرض مرئية"  Visible="false">
                                <Items>
                            ...
                            <telerik:RadMenuItem Text="التقارير" Visible="false">
                                <Items>
                            ...
                            <telerik:RadMenuItem Text="اعدادات النظام">
                                <Items>
                                    <telerik:RadMenuItem runat="server" NavigateUrl="~/aspx/Lookups/Contractors.aspx" Text="المقاولين">
                                    </telerik:RadMenuItem>
                                        <telerik:RadMenuItem runat="server" NavigateUrl="~/ASPX/Lookups/Consultans.aspx" Text="الإستشاريين">
                                    </telerik:RadMenuItem> 
                                      <telerik:RadMenuItem runat="server" NavigateUrl="~/ASPX/Lookups/Contracts.aspx" Text="العقود">
                                    </telerik:RadMenuItem> 
                                      <telerik:RadMenuItem runat="server" NavigateUrl="~/ASPX/Lookups/TableOfQuantity.aspx" Text="جدول الكميات">
                                    </telerik:RadMenuItem> 
                                      <telerik:RadMenuItem runat="server" NavigateUrl="~/ASPX/Lookups/UsersWorkOrders.aspx" Text="صلاحيات المستخدميين">
                                    </telerik:RadMenuItem> 
                                      <telerik:RadMenuItem runat="server" NavigateUrl="~/ASPX/Lookups/PMcontrols.aspx" Text="مدير المشروع">
                                    </telerik:RadMenuItem> 
                                 
                                   </Items>
                            </telerik:RadMenuItem>
                             <telerik:RadMenuItem Text="أوامر العمل">
                                <Items>
                                 
                                    <telerik:RadMenuItem runat="server" NavigateUrl="~/ASPX/Reports/CreateWorkOrder.aspx" Text="إنشاء أمر عمل">
                                    </telerik:RadMenuItem>
                                    <telerik:RadMenuItem runat="server" NavigateUrl="~/ASPX/Reports/CreateWorkOrder.aspx" Text="استعراض أمر عمل">
                                    </telerik:RadMenuItem>
                                     <telerik:RadMenuItem runat="server" NavigateUrl="~/ASPX/Reports/CreateWorkOrder.aspx" Text="أوامر عمل مقبولة">
                                    </telerik:RadMenuItem>
                                    <telerik:RadMenuItem runat="server" NavigateUrl="~/ASPX/Reports/CreateWorkOrder.aspx" Text="أوامر عمل مرفوضة">
                                    </telerik:RadMenuItem>
                                    <telerik:RadMenuItem runat="server" NavigateUrl="~/ASPX/Reports/CreateWorkOrder.aspx" Text="أوامر عمل تحتاج تعديل">
                                    </telerik:RadMenuItem>
                                    <telerik:RadMenuItem runat="server" NavigateUrl="~/ASPX/Reports/CreateWorkOrder.aspx" Text="أوامر عمل معلقة">
                                    </telerik:RadMenuItem>
                                    <telerik:RadMenuItem runat="server" NavigateUrl="~/ASPX/Reports/CreateWorkOrder.aspx" Text="أوامر عمل جديدة">
                                    </telerik:RadMenuItem>
                                    <telerik:RadMenuItem runat="server" NavigateUrl="~/ASPX/Reports/CreateWorkOrder.aspx" Text="أوامر عمل تحت الموافقة">
                                    </telerik:RadMenuItem>
                                      <telerik:RadMenuItem runat="server" NavigateUrl="~/ASPX/Lookups/Projects.aspx" Text="أوامر عمل اعتمدت تلقائيا" >
                                    </telerik:RadMenuItem> 
                                    <telerik:RadMenuItem runat="server" NavigateUrl="~/ASPX/Operations/MaintenanceOrders.aspx" Text="عرض امر عمل قديم" >
                                    </telerik:RadMenuItem>
