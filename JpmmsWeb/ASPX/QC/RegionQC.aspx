<%@ Page Title="ضبط الجودة لمسوحات مناطق الشوارع الفرعية" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master"
    AutoEventWireup="true" CodeFile="RegionQC.aspx.cs" Inherits="ASPX_QC_RegionQC" %>
        ...
        <tr>
            <td colspan="3">
                ...
                <asp:GridView ID="gvQChecks" runat="server" DataSourceID="odsQChecks" AllowPaging="True"
                    ...
                    OnRowDeleting="gvQChecks_RowDeleting" OnRowUpdating="gvQChecks_RowUpdating">
                    ...
                    <Columns>
                        ...
                        <asp:CommandField SelectText="تفاصيل" ShowSelectButton="True" ValidationGroup="edit"
                            CancelText="إلغاء" EditText="تعديل" ShowEditButton="True" UpdateText="حفظ" />
                    </Columns>
                ...
                <asp:ObjectDataSource ID="odsQChecks" runat="server" DeleteMethod="Delete" SelectMethod="GetAllRegionsQChecks"
