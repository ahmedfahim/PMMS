<%@ Page Title="تعديل بيانات أنفاق المقطع" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master"
    AutoEventWireup="true" CodeFile="EditTunnel.aspx.cs" Inherits="ASPX_Sections_EditTunnel" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="style1">
        <tr>
            ...
            <td>
                <h2 class="style2">
                    <b>تعديل بيانات أنفاق المقطع</b></h2>
            </td>
            <td>
                &nbsp;
            </td>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtBridgeName" runat="server" Width="397px"></asp:TextBox>
            </td>
            <td>
                &nbsp;
            </td>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <asp:DropDownList ID="ddlContractors" runat="server" AppendDataBoundItems="True"
                                DataSourceID="odsContractors" DataTextField="CONTRACTOR_NAME" 
