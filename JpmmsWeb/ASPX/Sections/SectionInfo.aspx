                                                ...
                                                <span class="style10">
                                                    ...
                                                    &nbsp; <span class="style8">
                                                        <asp:CheckBox ID="chkIllegal" runat="server" AutoPostBack="True" Enabled="False"
                                                            Text="غير نظامية" />
                                                        &nbsp;&nbsp; العدد
                                                        <telerik:RadNumericTextBox ID="rntxtSpeedBumpsCount" runat="server" Enabled="False"
                                            ...
                                            <td class="style10" colspan="3">
                                                <asp:Panel ID="pnlConcBlocks" runat="server" Visible="False">
                                                    <span class="style10">
                                                        ...
                                                        &nbsp;&nbsp; العدد
                                                        <telerik:RadNumericTextBox ID="rntxtConcreteBlocks" runat="server" Enabled="False"
                                                            MinValue="0" Width="50px">
                                                            <NumberFormat DecimalDigits="0" />
                                                        </telerik:RadNumericTextBox>
                                                    </span>
                                                ...
                                                <asp:Panel runat="server" ID="pnlServiceMainOpening" Visible="false">
                                                    <table>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <telerik:RadNumericTextBox ID="rntxtOpeningLength" runat="server" Enabled="False"
                                                                    MinValue="0" Width="50px">
                                                                    <NumberFormat DecimalDigits="2" />
                                                                </telerik:RadNumericTextBox>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <telerik:RadNumericTextBox ID="rntxtOpeningWidth" runat="server" Enabled="False"
                                                                    MinValue="0" Width="50px">
                                                                    <NumberFormat DecimalDigits="2" />
                                                                </telerik:RadNumericTextBox>
                                                            </td>
                                                ...
                                                <asp:Panel runat="server" ID="pnlUTurn" Visible="false">
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <span class="style10">الطول </span>
                                                                <telerik:RadNumericTextBox ID="rntxtUTurnLength" runat="server" Enabled="False" MinValue="0"
                                                                    Width="50px">
                                                                    <NumberFormat DecimalDigits="2" />
                                                                </telerik:RadNumericTextBox>
                                                            </td>
                                                            <td colspan="2">
                                                                ...
                                                                <telerik:RadNumericTextBox ID="rntxtUTurnWidth" runat="server" Enabled="False" MinValue="0"
                                                                    Width="50px">
                                                                    <NumberFormat DecimalDigits="2" />
                                                                </telerik:RadNumericTextBox>
                                                            </td>
