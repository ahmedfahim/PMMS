<%@ Page Title="تعديل بيانات جسور المقطع" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master"
    AutoEventWireup="true" CodeFile="EditBridge.aspx.cs" Inherits="ASPX_Sections_EditBridge" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="style1">
        <tr>
            ...
            <td>
                <h2 class="style2">
                    <b>تعديل بيانات جسور المقطع</b></h2>
            </td>
            <td>
                &nbsp;
            </td>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtBridgeNo" runat="server" MaxLength="3"></asp:TextBox>
            </td>
            <td>
                &nbsp;
            </td>
