<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master" AutoEventWireup="true" CodeFile="EquipmenSKIDIRI.aspx.cs" Inherits="ASPX_Archive_EquipmenSKIDIRI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="style1">
        <tr>
            ...
            <td>
                <h2 class="style2">
                    شوارع تحتاج المسح&nbsp; بمعدة IRI وتم مسحها بمعدة 
