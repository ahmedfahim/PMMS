<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master" AutoEventWireup="true" CodeFile="IntersectionReviewed.aspx.cs" Inherits="ASPX_Archive_IntersectionReviewed" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    &nbsp;<table class="style1">
        <tr>
            ...
            <td>
                <h2 class="style2">
                    مراجعة وتدقيق تقاطعات المسح البصري</h2>
            </td>
            <td>
                &nbsp;
            </td>
                            ...
                            <td colspan="2">
                                <asp:Panel ID="PanelNewStreets" runat="server" Visible="true">
                                    ...
                                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                        SelectMethod="GetInterSectReceivedReviewed" TypeName="JpmmsClasses.BL.Lookups.SystemUsers" 
                                        UpdateMethod="UpdateReceivedInterSectReviewed">
                                        <UpdateParameters>
