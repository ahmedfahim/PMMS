<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master" AutoEventWireup="true" CodeFile="RegionsErorr.aspx.cs" Inherits="ASPX_Archive_RegionsErorr" %>
        ...
        <tr>
            ...
            <td>
                <asp:GridView ID="gvRegionSamples" runat="server" CellPadding="4" EnableModelValidation="True"
                    ...
                    <Columns>
                        <asp:BoundField DataField="COUNT" HeaderText="عدد مرات التكرار" 
        ...
        <tr>
            <td colspan="3" class="style3">
                <asp:Panel ID="pnlSurveyor" runat="server">
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetAllRegionsErorrs"
