<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master" AutoEventWireup="true" CodeFile="DataEntryFinshed.aspx.cs" Inherits="ASPX_Archive_DataEntryFinshed" %>
                            ...
                            <td colspan="2">
                                <asp:Panel ID="PanelNewStreets" runat="server" Visible="true">
                                        ...
                                        <AlternatingRowStyle BackColor="White" />
                                          <Columns>
                                              ...
                                              <asp:TemplateField HeaderText="رقم المنطقة" SortExpression="REGION_NO">
                                                  <EditItemTemplate>
                                                      <asp:Label ID="Label1" runat="server" Text='<%# Bind("REGION_NO") %>'></asp:Label>
                                                  </EditItemTemplate>
                                                  <ItemTemplate>
                                                      <asp:Label ID="Label1" runat="server" Text='<%# Bind("REGION_NO") %>'></asp:Label>
                                                  </ItemTemplate>
                                              ...
                                              <asp:CommandField EditText="إدخال" ShowEditButton="True" CancelText="إلغاء" 
                                                  UpdateText="حفظ" />
                                        </Columns>
                                    ...
                                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                        SelectMethod="GetReceivedDataEntry" 
                                        TypeName="JpmmsClasses.BL.Lookups.SystemUsers" 
                                        UpdateMethod="UpdateDataEntryFinish">
                                        <SelectParameters>
