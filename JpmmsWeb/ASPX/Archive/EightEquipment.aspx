<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master"
    AutoEventWireup="true" CodeFile="EightEquipment.aspx.cs" Inherits="ASPX_Archive_EightEquipment" %>
        ...
        <tr>
            <td colspan="3" class="style3">
                <asp:Panel ID="pnlSurveyor" runat="server">
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetRecivedEditIRILanes"
                        TypeName="JpmmsClasses.BL.MainStreet" UpdateMethod="UpdateRecivedEditIRILanes">
                        <UpdateParameters>
