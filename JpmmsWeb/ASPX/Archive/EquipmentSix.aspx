<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master"
    AutoEventWireup="true" CodeFile="EquipmentSix.aspx.cs" Inherits="ASPX_Archive_EquipmentSix" %>
                                ...
                                <td>
                                    <asp:GridView ID="gvRegionSamplesIRI" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="SECTION_ID" HeaderText="الرقم الفريد للمقطع" ReadOnly="True" />
