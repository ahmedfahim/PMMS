<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master" AutoEventWireup="true" CodeFile="DefaultUDIStreet.aspx.cs" Inherits="ASPX_Archive_DefaultUDIStreet" %>
        ...
        <tr>
            <td colspan="3">
                <asp:GridView ID="gvRegionSamples" runat="server" DataSourceID="odsRegionSamples"
                    ...
                    GridLines="None" AllowPaging="True" EnableModelValidation="True"
                    PageSize="15">
                ...
                <asp:ObjectDataSource ID="odsRegionSamples" runat="server" SelectMethod="GetRegionSamples"
                    TypeName="JpmmsClasses.BL.Region" onselected="odsRegionSamples_Selected">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="ddlRegions" Name="regionID" PropertyName="SelectedValue"
                            Type="Int32" />
                    </SelectParameters>
        ...
        <tr>
            ...
            <asp:GridView ID="gvRegionSamplesOLD" runat="server" DataSourceID="odsRegionSamplesOLD"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="الطول" SortExpression="SECOND_ST_LENGTH">
                            <EditItemTemplate>
                                <telerik:RadNumericTextBox ID="rntxtLengthSecST0" runat="server" 
                                    Culture="ar-QA" DataType="System.Double"
                                    DbValue='<%# Bind("SECOND_ST_LENGTH") %>' MinValue="0" Width="125px">
                                </telerik:RadNumericTextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                ...
                <asp:ObjectDataSource ID="odsRegionSamplesOLD" runat="server" SelectMethod="GetRegionSamplesUDI"
                    TypeName="JpmmsClasses.BL.Region" 
                    onselected="odsRegionSamplesOLD_Selected">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="ddlRegions" Name="regionID" PropertyName="SelectedValue"
                            Type="Int32" />
                    </SelectParameters>
