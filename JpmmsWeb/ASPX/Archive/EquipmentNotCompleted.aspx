<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master"
    AutoEventWireup="true" CodeFile="EquipmentNotCompleted.aspx.cs" Inherits="ASPX_Archive_EquipmentNotCompleted" %>
            ...
            <td>
                <asp:GridView ID="gvRegionSamples" runat="server" CellPadding="4" EnableModelValidation="True"
                    ...
                    <Columns>
                        ...
                        <asp:CheckBoxField DataField="COMPLETING" HeaderText="تم الإكمال" SortExpression="COMPLETING"
                            ReadOnly="True" />
        ...
        <tr>
            <td colspan="3" class="style3">
                <asp:Panel ID="pnlSurveyor" runat="server">
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetIsNotComplete"
                        TypeName="JpmmsClasses.BL.MainStreet" UpdateMethod="UpdateIsNotComplete">
                        <UpdateParameters>
