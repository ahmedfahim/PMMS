...
public partial class ASPX_Archive_EquipmentFiveteenValid : System.Web.UI.Page
{
    ...
    private void BOUNDSECTIONS()
    {
        ...
        ddlMainStreets.DataSource = new JpmmsClasses.BL.MainStreet().GetNewStreetsGis(true);
    ...
    {
        if (Session["UserID"] != null && Session["UserID"].ToString() == "55")
        {
    ...
    {
        if (ddlMainStreets.SelectedValue != "-1" && new JpmmsClasses.BL.MainStreet().InsertNewStreetsGis(int.Parse(ddlMainStreets.SelectedValue),true))
        {
