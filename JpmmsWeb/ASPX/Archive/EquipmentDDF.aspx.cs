...
public partial class ASPX_Archive_EquipmentDDF : System.Web.UI.Page
{
    ...
    protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            float SUM = 0f;
            lblFeedbackTotal.Text = "  إجمالي الممسوح  " + new JpmmsClasses.BL.Lookups.MaintDecision().GetAllDecisionsDDF() + " كيلو متر ";
            gvRegionSamples.DataSource = new JpmmsClasses.BL.MainStreet().CompareDDF(DropDownList1.SelectedValue);
