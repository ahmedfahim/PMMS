<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master" AutoEventWireup="true" CodeFile="ISEquipmentIRIDDF.aspx.cs" Inherits="ASPX_Archive_ISEquipmentIRIDDF" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    &nbsp;<table class="style1">
        <tr>
            ...
            <td>
                <h2 class="style2">
                    الشوارع الرئيسية اعاده للمعدة</h2>
            </td>
            <td>
                &nbsp;
            </td>
            ...
            <td>
                <asp:GridView ID="gvRegionSamples" runat="server" CellPadding="4" EnableModelValidation="True"
                    ...
                    <Columns>
                        ...
                        <asp:CheckBoxField DataField="IS_EQUIPMENT" HeaderText="اعاده للمعدة" ReadOnly="True"
                            SortExpression="IS_EQUIPMENT" />
                            <asp:BoundField DataField="SURVEY_NO" HeaderText="المسحة" ReadOnly="True"
        ...
        <tr>
            <td colspan="3" class="style3">
                <asp:Panel ID="pnlSurveyor" runat="server">
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="FinshedRrturnToMFVDelete"
