<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master"
    AutoEventWireup="true" CodeFile="EquipmentOne.aspx.cs" Inherits="ASPX_Archive_EquipmentOne" %>
        ...
        <ContentTemplate>
            <table class="style1">
                <tr>
                    ...
                    <td>
                        <h2 class="style2">
                            إستوائية رصف الطريق مقاطع&nbsp;&nbsp; IRI</h2>
                    </td>
                    <td>
                        &nbsp;
                    </td>
                                ...
                                <td colspan="2">
                                    <b>
                                        <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal"
                                            Enabled="false" AutoPostBack="True" OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged">
