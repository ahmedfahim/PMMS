<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master"
    AutoEventWireup="true" CodeFile="SevenEquipment.aspx.cs" Inherits="ASPX_Archive_SevenEquipment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    &nbsp;<table class="style1">
        <tr>
            ...
            <td>
                <h2 class="style2">
                    تحديث ادخال الشوارع الرئيسية</h2>
            </td>
            <td>
                &nbsp;
            </td>
            ...
            <td>
                <asp:GridView ID="gvRegionSamples" runat="server" CellPadding="4" EnableModelValidation="True"
                    ...
                    <Columns>
                        ...
                        <asp:CheckBoxField DataField="UPDATING" HeaderText="تحديث الإدخال" SortExpression="UPDATING" />
                        ...
                        <asp:BoundField DataField="SURVEY_NO" ReadOnly="True" HeaderText="المسحة" SortExpression="SURVEY_NO" />
                    </Columns>
        ...
        <tr>
            <td colspan="3" class="style3">
                <asp:Panel ID="pnlSurveyor" runat="server">
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetRecivedEditIRI"
                        TypeName="JpmmsClasses.BL.MainStreet" UpdateMethod="UpdateRecivedEditIRI">
                        <UpdateParameters>
                            <asp:Parameter Name="MAIN_NO" Type="String" />
                            <asp:Parameter Name="UPDATING" Type="Boolean" />
                            <asp:Parameter Name="IS_TRANSFARE_ERROR" Type="Boolean" />
                        </UpdateParameters>
