<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master"
    AutoEventWireup="true" CodeFile="InterSectionNotFinshed.aspx.cs" Inherits="ASPX_Archive_InterSectionNotFinshed" %>
                                ...
                                <asp:Panel ID="PanelNewStreets" runat="server" Visible="true">
                                    <asp:GridView ID="gvRegionSamples" runat="server" CellPadding="4" EnableModelValidation="True"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:CheckBoxField DataField="IS_DATAENTRYFINSH" HeaderText="حالة الإدخال" SortExpression="IS_DATAENTRYFINSH" />
                                            <asp:CheckBoxField DataField="IS_REVIEWGIS" HeaderText="اضافه او حذف" SortExpression="IS_REVIEWGIS" />
                                        </Columns>
