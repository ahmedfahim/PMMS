<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master"
    AutoEventWireup="true" CodeFile="ErorrSurvey.aspx.cs" Inherits="ASPX_Archive_ErorrSurvey" %>
                        ...
                        <td>
                            <asp:GridView ID="gvErorr" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="SURVEY_NO" HeaderText="المسح الخطأ" SortExpression="SURVEY_NO" />
                                    <asp:BoundField DataField="CLEARANCE" HeaderText="المستخلص" SortExpression="CLEARANCE" />
                                     <asp:BoundField DataField="Right_SURVEY" HeaderText="المسح الصحيح" SortExpression="Right_SURVEY" />
                                </Columns>
