<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master"
    AutoEventWireup="true" CodeFile="EquipmentDDF.aspx.cs" Inherits="ASPX_Archive_EquipmentDDF" %>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:DropDownList ID="DropDownList1" runat="server" AppendDataBoundItems="True" AutoPostBack="True"
                            DataSourceID="ObjectDataSource1" DataTextField="CLEARANCE_DDF" DataValueField="CLEARANCE_DDF"
                    ...
                    <td>
                        <asp:GridView ID="gvRegionSamples" runat="server" CellPadding="4" EnableModelValidation="True"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CLEARANCE_DDF" HeaderText="المستخلص رقم" SortExpression="CLEARANCE_DDF" />
                ...
                <tr>
                    <td colspan="3" class="style3">
                        <asp:Panel ID="pnlSurveyor" runat="server">
                            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="CompareDDF"
