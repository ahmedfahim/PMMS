<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master"
    AutoEventWireup="true" CodeFile="EquipmentEight.aspx.cs" Inherits="ASPX_Archive_EquipmentEight" %>
        ...
        <ContentTemplate>
            <table class="style1">
                <tr>
                    ...
                    <td>
                        <h2 class="style2">
                            مقارنة العيوب مع حاله الوعورة &nbsp;DDF - IRI</h2>
                    </td>
                    <td>
                        &nbsp;
                    </td>
                        ...
                        <table align="center" class="style3">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:ObjectDataSource ID="odsRegions" runat="server" SelectMethod="GetStreetsDDF"
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="gvRegionSamplesIRI" runat="server" AutoGenerateColumns="False"
                                        ...
                                        OnSelectedIndexChanging="gvRegionSamplesIRI_SelectedIndexChanging">
                                        <AlternatingRowStyle BackColor="White" />
                                        <Columns>
                                            ...
                                            <asp:CommandField SelectText="نضيف" ShowSelectButton="True" />
                                        </Columns>
                                        <EditRowStyle BackColor="#2461BF" />
                                        <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                        <HeaderStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                ...
                                <td>
                                    <asp:GridView ID="gvRegionSamplesSECTION" runat="server" AutoGenerateColumns="False"
                                        ...
                                        OnSelectedIndexChanging="gvRegionSamplesSECTION_SelectedIndexChanging">
                                        <AlternatingRowStyle BackColor="White" />
                                        <Columns>
                                            <asp:BoundField DataField="SECTION_NO" HeaderText="رقم المقطع" />
                                            <asp:BoundField DataField="LANE" HeaderText="نوع الحارة" />
