<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master"
    AutoEventWireup="true" CodeFile="EquipmentSamples.aspx.cs" Inherits="ASPX_Archive_EquipmentSamples" %>
                                ...
                                <td colspan="2">
                                    <b>
                                        <asp:RadioButtonList ID="RadioButtonList1" runat="server" Visible="false" RepeatDirection="Horizontal">
                                            ...
                                            <asp:ListItem Value="4" Enabled="False">المسح الحالي</asp:ListItem>
                                        </asp:RadioButtonList>
                                    </b>
                                </td>
                                <td>
                                ...
                                <td>
                                    <asp:GridView ID="gvRegionSamplesIRI" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="الرقم الفريد للعينة" DataField="SAMPLE_ID" ReadOnly="True" />
