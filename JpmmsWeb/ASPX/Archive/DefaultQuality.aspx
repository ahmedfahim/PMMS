<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master" AutoEventWireup="true" CodeFile="DefaultQuality.aspx.cs" Inherits="ASPX_Archive_DefaultQuality" %>
                                    ...
                                    <asp:GridView ID="gvRegionSamples" runat="server" 
                                        ...
                                        <AlternatingRowStyle BackColor="White" />
                                          <Columns>
                                              ...
                                              <asp:TemplateField HeaderText="اسم المستخدم" SortExpression="USERNAME">
                                                  <EditItemTemplate>
                                                      ...
                                                      <asp:ObjectDataSource ID="ObjecDataTemplate1" runat="server" 
                                                          SelectMethod="GetFilterUsersQuality" 
                                            ...
                                            <asp:CommandField SelectText="تسليم" 
