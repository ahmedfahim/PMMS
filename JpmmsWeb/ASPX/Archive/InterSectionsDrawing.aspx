<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master" AutoEventWireup="true" CodeFile="InterSectionsDrawing.aspx.cs" Inherits="ASPX_Archive_InterSectionsDrawing" %>
        ...
        <tr>
            ...
            <td>
                <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal"
                    ...
                    <asp:ListItem Value="0">لايوجد تقاطعات</asp:ListItem>
                    <asp:ListItem Value="1">يوجد تقاطعات</asp:ListItem>
                </asp:RadioButtonList>
                ...
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetRecivedDrawingIntersectionsIRI"
