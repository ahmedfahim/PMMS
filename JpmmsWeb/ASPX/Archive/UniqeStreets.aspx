<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master" AutoEventWireup="true" CodeFile="UniqeStreets.aspx.cs" Inherits="ASPX_Archive_UniqeStreets" %>
            ...
            <td colspan="3">
                <asp:GridView ID="gvRegionSamples" runat="server" DataSourceID="odsRegionSamples"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="DISTRESS" HeaderText="العيوب" />
                        <asp:CommandField HeaderText="حذف" SelectText="حذف" ShowSelectButton="True" />
                    </Columns>
