...
public partial class ASPX_Archive_EquipmentSeven : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString.Count == 1)
            {
                ...
                gvRegionSamplesIRI.DataSource = new JpmmsClasses.BL.MainStreet().GetStreetsSampleDublicateIRI();
