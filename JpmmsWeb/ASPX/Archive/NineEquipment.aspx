<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master"
    AutoEventWireup="true" CodeFile="NineEquipment.aspx.cs" Inherits="ASPX_Archive_NineEquipment" %>
        ...
        <tr>
            <td colspan="3" class="style3">
                <asp:Panel ID="pnlSurveyor" runat="server">
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetRecivedEditIRISampleLanes"
                        TypeName="JpmmsClasses.BL.MainStreet" UpdateMethod="UpdateRecivedEditIRISampleLanes">
                        <UpdateParameters>
