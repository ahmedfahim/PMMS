<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master"
    AutoEventWireup="true" CodeFile="InterSectionReportReview.aspx.cs" Inherits="ASPX_Archive_InterSectionReportReview" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    &nbsp;<table class="style1">
        <tr>
            ...
            <td>
                <h2 class="style2">
                    مراجعة التقاطعات لحساب حالة الرصف وقرارات الصيانة</h2>
            </td>
            <td>
                &nbsp;
            </td>
            ...
            <td colspan="3" class="style3">
                <asp:Panel ID="pnlSurveyor" runat="server">
                    <table align="center" width="60%">
                        <tr>
                            <td>
                                <asp:Button ID="BtnEND" runat="server" ForeColor="Red" OnClick="BtnEND_Click" Text="نهاية الشهر" />
                                ...
                                <asp:Button ID="btnMainStreetsUdi" runat="server" OnClick="btnMainStreetsUdi_Click"
                                    OnClientClick="return confirm('حساب حالة الرصف سيستغرق وقتا، هل تريد مواصلة الحساب؟');"
                                    Text="حساب حالة الرصف للكل" Width="130px" />
                                <asp:Button ID="btnMainStreetsMin" runat="server" OnClick="btnMainStreetsMin_Click"
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:Panel ID="PanelNewStreets" runat="server" Visible="true">
                                    <asp:GridView ID="gvRegionSamples" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                        CellPadding="4" DataSourceID="ObjectDataSource1" EnableModelValidation="True"
                                        ForeColor="#333333" GridLines="None" OnRowUpdating="gvRegionSamples_RowUpdating"
                                        PageSize="15" OnDataBound="gvRegionSamples_DataBound">
                                        <AlternatingRowStyle BackColor="White" />
                                        <Columns>
                                            <asp:BoundField DataField="NUMROW" HeaderText="مسلسل" ReadOnly="True" SortExpression="NUMROW" />
                                            ...
                                            <asp:TemplateField HeaderText="رقم التقاطع" SortExpression="INTER_NO">
                                                <EditItemTemplate>
                                                    <asp:Label ID="Label8" runat="server" Text='<%# Bind("INTER_NO") %>'></asp:Label>
                                                </EditItemTemplate>
                                                <ItemTemplate>
                                                    <asp:Label ID="Label9" runat="server" Text='<%# Bind("INTER_NO") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                    ...
                                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetReceivedInterSectReports"
                                        TypeName="JpmmsClasses.BL.Lookups.SystemUsers" UpdateMethod="UpdateRePortInterSectReviewed">
                                        <UpdateParameters>
