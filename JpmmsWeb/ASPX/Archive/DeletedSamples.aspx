<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master" AutoEventWireup="true" CodeFile="DeletedSamples.aspx.cs" Inherits="ASPX_Archive_DeletedSamples" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    &nbsp;<table class="style1">
        <tr>
            ...
            <td>
                <h2 class="style2">
                    بيانات العينات المحذوفه ومدخل عليها عيوب</h2>
            </td>
            <td>
                &nbsp;
            </td>
        ...
        <tr>
            ...
            <td>
                <asp:GridView ID="gvRegionSamples" runat="server" CellPadding="4" EnableModelValidation="True"
                    ...
                    <Columns>
                        <asp:BoundField DataField="SAMPLE_ID" HeaderText="رقم العينة" 
                ...
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                    SelectMethod="GetStreetsDeltedSamples" TypeName="JpmmsClasses.BL.MainStreet">
