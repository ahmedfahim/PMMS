<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master"
    AutoEventWireup="true" CodeFile="EquipmentIRI.aspx.cs" Inherits="ASPX_Archive_EquipmentIRI" %>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:DropDownList ID="DropDownList1" runat="server" AppendDataBoundItems="True" AutoPostBack="True"
                            DataSourceID="ObjectDataSource1" DataTextField="CLEARANCE_IRI" DataValueField="CLEARANCE_IRI"
                    ...
                    <td>
                        <asp:GridView ID="gvRegionSamples" runat="server" CellPadding="4" EnableModelValidation="True"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="STREET_IRI_LEN" HeaderText="الطول من المعدة" SortExpression="STREET_IRI_LEN" />
                                <asp:BoundField DataField="CLEARANCE_IRI" HeaderText="المستخلص رقم" SortExpression="CLEARANCE_IRI" />
                ...
                <tr>
                    <td colspan="3" class="style3">
                        <asp:Panel ID="pnlSurveyor" runat="server">
                            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="CompareIRI"
