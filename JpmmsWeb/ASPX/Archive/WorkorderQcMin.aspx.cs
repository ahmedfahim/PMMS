...
public partial class ASPX_Archive_WorkorderQcMin : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            gvRegionSamples.DataSource = new JpmmsClasses.BL.Lookups.SystemUsers().GetReceivedMaintinanceStreets();
