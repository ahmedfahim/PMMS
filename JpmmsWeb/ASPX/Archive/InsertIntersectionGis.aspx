<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master" AutoEventWireup="true" CodeFile="InsertIntersectionGis.aspx.cs" Inherits="ASPX_Archive_InsertIntersectionGis" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    &nbsp;<table class="style1">
        <tr>
            ...
            <td>
                <h2 class="style2">
                    إستلام ملفات المسح الجغرافي تقاطعات</h2>
            </td>
            <td>
                &nbsp;
            </td>
                            ...
                            <td colspan="2">
                                <asp:Panel ID="PanelNewStreets" runat="server" Visible="true">
                                    ...
                                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                        SelectMethod="GetReceivedInterSectGis" TypeName="JpmmsClasses.BL.Lookups.SystemUsers" 
                                        UpdateMethod="UpdateReceivedInterSectGisFinish">
                                        <UpdateParameters>
