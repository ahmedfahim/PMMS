<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master"
    AutoEventWireup="true" CodeFile="NinteenEquipment.aspx.cs" Inherits="ASPX_Archive_NinteenEquipment" %>
            ...
            <td>
                <asp:GridView ID="gvRegionSamples" runat="server" CellPadding="4" EnableModelValidation="True"
                    ...
                    <Columns>
                        ...
                        <asp:CheckBoxField DataField="EDITING" HeaderText="تحديث الإدخال" SortExpression="EDITING" />
        ...
        <tr>
            <td colspan="3" class="style3">
                <asp:Panel ID="pnlSurveyor" runat="server">
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="FinshedRrturnToMFV"
                        TypeName="JpmmsClasses.BL.MainStreet" UpdateMethod="UpdateRrturnToMFV">
                        <UpdateParameters>
