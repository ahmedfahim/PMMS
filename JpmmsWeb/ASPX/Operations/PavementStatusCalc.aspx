        ...
        <tr>
            <td style="margin-right: 80px">
                <asp:RadioButton ID="radByMonth" runat="server" AutoPostBack="True" GroupName="report"
                    Text="شهري" OnCheckedChanged="radByMonth_CheckedChanged" Font-Bold="True" />
            </td>
            <td colspan="2" rowspan="2">
                ...
                <asp:DropDownList ID="DrpDwnListMonth" runat="server" AppendDataBoundItems="True"
                    DataSourceID="ObjectDataSource1" DataTextField="REPORTMONTH_TITLE" DataValueField="REPORTMONTH_ID">
                    ...
                    <tr>
                        <td>
                            <asp:Button ID="btnShowReport" runat="server" OnClick="btnShowReport_Click" Text="حساب حالة الرصف"
                                Width="190px" />
                            <%--<asp:Button ID="btnCancel" runat="server" OnClick="btnCancel_Click" Text="إلغاء" Width="110px"/>--%>
                            <asp:Button ID="btnRoadNetworkUdiCalc" runat="server" OnClick="btnRoadNetworkUdiCalc_Click"
                                ...
                                Text="حساب حالة الرصف لكامل الشبكة" Width="190px" Enabled="False" />
                        </td>
                        <td>
                            <asp:Button ID="btnMainStreets" runat="server" OnClick="btnMainStreets_Click" Text="حساب حالة الرصف كل الشوارع الرئيسية"
                                Width="210px" OnClientClick="return confirm('حساب حالة الرصف كل الشوارع الرئيسية سيستغرق وقتا، هل تريد مواصلة الحساب؟');" />
                            <asp:Button ID="btnRegions" runat="server" Text="حساب حالة الرصف كل المناطق الفرعية"
                                Width="210px" OnClientClick="return confirm('حساب حالة الرصف كل المناطق الفرعية سيستغرق وقتا، هل تريد مواصلة الحساب؟');"
