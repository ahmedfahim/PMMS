<%@ Page Title="أوامر العمل" Language="C#" MasterPageFile="~/MasterPage/ServicesWorkOrders.master"
            ...
            <td colspan="2" style="text-align: center" width="40%">
                <table class="style1">
                    ...
                    <tr>
                        ...
                        <td style="margin-right: 40px">
                            <asp:LinkButton ID="btnAddContractor" runat="server" OnClick="btnAddContractor_Click" Visible="false">إضافة مقاول</asp:LinkButton>
                            <br />
                    ...
                    <tr>
                        ...
                        <td style="margin-right: 40px" class="style4">
                            <br />
                            <asp:DropDownList ID="ddlWorkStatus" runat="server" Visible="false">
