<%@ Page Title="حساب قرارات الصيانة لعناصر شبكة الطرق" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master"
    AutoEventWireup="true" CodeFile="MaintenanceDecisionCalc.aspx.cs" Inherits="ASPX_Operations_MaintenanceDecisionCalc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="style1">
        <tr>
            ...
            <td class="style2">
                <h2>
                    حساب قرارات الصيانة لعناصر شبكة الطرق</h2>
            </td>
            <td>
                &nbsp;
            </td>
        ...
        <tr>
            ...
            <td>
                <table class="style3">
                    <tr>
                        <td>
                            <asp:Button ID="btnShowReport" runat="server" OnClick="btnShowReport_Click" Text="حساب قرارات الصيانة"
                                Width="200px" />
                            <%--<asp:Button ID="btnCancel" runat="server" OnClick="btnCancel_Click" Text="إلغاء"
                                ...
                                OnClientClick="return confirm('حساب قرارات الصيانة لكامل الشبكة سيستغرق وقتا، هل تريد مواصلة الحساب؟');"
                                Text="حساب قرارات الصيانة لكامل الشبكة" Width="200px" Enabled="False" />
                        </td>
                        <td>
                            <asp:Button ID="btnMainStreets" runat="server" OnClick="btnMainStreets_Click" Text="حساب قرارات الصيانة كل الشوارع الرئيسية"
                                Width="220px" OnClientClick="return confirm('حساب قرارات الصيانة كل الشوارع الرئيسية سيستغرق وقتا، هل تريد مواصلة الحساب؟');" />
                           <asp:Button ID="btnRegions" runat="server"  Text="حساب قرارات الصيانة كل المناطق الفرعية"
                                Width="220px" 
                                OnClientClick="return confirm('حساب قرارات الصيانة كل المناطق الفرعية سيستغرق وقتا، هل تريد مواصلة الحساب؟');" 
                                onclick="btnRegions_Click" />
                        </td>
                    </tr>
                </table>
            </td>
