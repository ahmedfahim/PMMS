<%@ Page Title="المقاولين" Language="C#" MasterPageFile="~/MasterPage/ServicesWorkOrders.master"
    AutoEventWireup="true" CodeFile="Contractors.aspx.cs" Inherits="ASPX_Lookups_Contractors" %>
            ...
            <td colspan="3">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="CONTRACTOR_No" HeaderText="رقم المقاول" SortExpression="CONTRACTOR_No" />
                        <asp:BoundField DataField="CONTRACTOR_NAME" HeaderText="اسم المقاول" SortExpression="CONTRACTOR_NAME" />
                        <asp:BoundField DataField="PHONE" HeaderText="رقم الهاتف" SortExpression="PHONE" />
                        <asp:BoundField DataField="FAX" HeaderText="فاكس" SortExpression="FAX" />
                        <asp:BoundField DataField="MOBILE" HeaderText="جوال" SortExpression="MOBILE" />
