<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesWorkOrders.master" AutoEventWireup="true" CodeFile="Contracts.aspx.cs" Inherits="ASPX_Lookups_Contracts" %>
                    ...
                    <InsertItemTemplate>
                        <table class="style1">
                            ...
                            <tr>
                                ...
                                <td style="margin-right: 160px">
                                    <asp:TextBox ID="TextBox4" Width="120px" runat="server" Text='<%# Bind("EMAIL") %>' />
                                </td>
                                <td>
                                    &nbsp;
                                </td>
                                ...
                                <td style="margin-right: 160px">
                                    <asp:TextBox ID="TextBox6" Width="120px" runat="server" Text='<%# Bind("EMAIL") %>' />
                                </td>
                                <td>
                                    &nbsp;
                                </td>
                                 ...
                                 <tr>
                                <td>
                                    مدير المشروع بالأمانه
                                </td>
                                <td style="margin-right: 160px">
                                    <asp:TextBox ID="TextBox2" Width="120px" runat="server" Text='<%# Bind("ProjectManager") %>' />
                                </td>
                                <td>
                                    &nbsp;
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="margin-right: 160px">
                                   <asp:DropDownList ID="DropDownddlMunic" runat="server" AutoPostBack="True" 
                                    ...
                                    DataValueField="MUNIC_ID" Width="125px" AppendDataBoundItems="True" 
            ...
            <td colspan="3">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="CONTRACTOR_NAME" HeaderText="اسم العقد" 
                            SortExpression="CONTRACTOR_NAME" />
                        <asp:BoundField HeaderText="رقم العقد" />
                        <asp:BoundField HeaderText="رقم المقاول" />
                        <asp:BoundField DataField="CONTRACTOR_No" HeaderText="رقم الإستشاري" SortExpression="CONTRACTOR_No" />
                        <asp:BoundField DataField="PHONE" HeaderText="بداية العقد" 
                            SortExpression="PHONE" />
                        <asp:BoundField DataField="FAX" HeaderText="نهاية العقد" SortExpression="FAX" />
                        <asp:BoundField DataField="MOBILE" HeaderText="مدة العقد" 
                            SortExpression="MOBILE" />
                        <asp:BoundField DataField="EMAIL" HeaderText="اجمالي تكلفة العقد" 
                            SortExpression="EMAIL" />
<asp:BoundField HeaderText="نطاق العقد"></asp:BoundField>
                        <asp:BoundField HeaderText="مدير المشروع" />
