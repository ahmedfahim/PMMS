<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesWorkOrders.master" AutoEventWireup="true" CodeFile="UsersWorkOrders.aspx.cs" Inherits="ASPX_Lookups_UsersWorkOrders" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="style1">
        <tr>
            ...
            <td class="style2">
                <h2>
                    <strong>صلاحيات مستخدمي نظام أوامر العمل</strong></h2>
            </td>
            <td>
                &nbsp;
            </td>
                            ...
                            <tr>
                                ...
                                <td style="margin-right: 80px">
                                    <asp:DropDownList ID="DropDownList1" runat="server">
                                        <asp:ListItem Value="-1">اختر الصلاحية</asp:ListItem>
                                        <asp:ListItem Value="1">مدير عام التشغيل والصيانة</asp:ListItem>
                                        <asp:ListItem Value="2">مدير إدارة صيانة الطرق</asp:ListItem>
                                        <asp:ListItem Value="3">مدير المشروع بالأمانة</asp:ListItem>
                                        <asp:ListItem Value="4">الاستشاري</asp:ListItem>
                                        <asp:ListItem Value="5">رخص الحفريات</asp:ListItem>
                                        <asp:ListItem Value="6">المقاول</asp:ListItem>
            ...
            <td colspan="3">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="CONTRACTOR_NAME" HeaderText="اسم المستخدم" 
                            SortExpression="CONTRACTOR_NAME" />
                        <asp:BoundField DataField="CONTRACTOR_No" HeaderText="نوع الصلاحية" 
