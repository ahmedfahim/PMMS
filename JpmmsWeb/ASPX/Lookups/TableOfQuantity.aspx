<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesWorkOrders.master" AutoEventWireup="true" CodeFile="TableOfQuantity.aspx.cs" Inherits="ASPX_Lookups_TableOfQuantity" %>
                            ...
                            <tr>
                                ...
                                <td style="margin-right: 80px">
                                    <asp:DropDownList ID="DropDownList1" runat="server">
                                        <asp:ListItem Value="-1">اختر الوحدة</asp:ListItem>
                                        <asp:ListItem Value="1">م3</asp:ListItem>
                                        <asp:ListItem Value="2">م2</asp:ListItem>
                                        <asp:ListItem Value="3">م.ط</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                                <td>
                                    &nbsp;
            ...
            <td colspan="3">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="CONTRACTOR_No" HeaderText="رقم القسم" 
                            SortExpression="CONTRACTOR_No" />
                        <asp:BoundField DataField="CONTRACTOR_NAME" HeaderText="مسمي البند" 
                            SortExpression="CONTRACTOR_NAME" />
                        <asp:BoundField DataField="PHONE" HeaderText="رقم البند" 
                            SortExpression="PHONE" />
                        <asp:BoundField DataField="FAX" HeaderText="رقم العقد" SortExpression="FAX" />
                        <asp:BoundField DataField="MOBILE" HeaderText="الوحدة" 
