...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="100%">
        ...
        <tr>
            <td class="style1">
                <asp:LinkButton ID="lnkReports" runat="server" OnClick="lnkReports_Click" Visible="false">استعراض تقارير النظام</asp:LinkButton>
            </td>
            <td class="style4">
        ...
        <tr>
            ...
            <td class="style4">
                <asp:TextBox ID="txtUserName" runat="server" Width="150px" BorderColor="#FFFFCC" Enabled="false"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="style1">
            ...
            <td class="style4">
                <asp:TextBox ID="txtPassword" TextMode="Password" runat="server" Width="150px" BorderColor="#FFFFCC" Enabled="false" ></asp:TextBox>
            </td>
        </tr>
        <tr>
