<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MdResults.aspx.cs" Inherits="ASPX_Intersections_MdResults" %>
...
<body>
    ...
    <asp:GridView ID="gvIntersectMaintDecisions" runat="server" AutoGenerateColumns="False"
        ...
        <Columns>
            <%--  DataKeyNames="RECORD_ID" <asp:BoundField DataField="RECORD_ID" HeaderText="RECORD_ID" ReadOnly="True" SortExpression="RECORD_ID"
                Visible="False" />--%>
            <asp:BoundField DataField="INTERSECT_TITLE" HeaderText="الوصف" SortExpression="INTERSECT_TITLE" />
            ...
            <asp:BoundField DataField="MAINT_DECISION" HeaderText="قرار الصيانة" SortExpression="MAINT_DECISION" />
