<%@ Page Title="تقرير مستوى وعورة الطرق الرئيسية" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master"
    AutoEventWireup="true" CodeFile="IRI_ReportWith1stSurvey.aspx.cs" Inherits="ASPX_Reports_IRI_ReportWith1stSurvey" %>
        ...
        <tr>
            ...
            <td>
                <asp:ObjectDataSource ID="odsMainStreets" runat="server" SelectMethod="LoadMainStreetsHavingCalculatedIri"
                    ...
                    <SelectParameters>
                        <asp:ControlParameter ControlID="radByMainLanes" Name="forMainStreetLanes" PropertyName="Checked"
                            Type="Boolean" />
                    </SelectParameters>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlMainStreets" runat="server" AppendDataBoundItems="True"
                    ...
                    DataValueField="main_no" OnSelectedIndexChanged="ddlMainStreets_SelectedIndexChanged">
            ...
            <td class="style4">
                <b>
                    <asp:RadioButton ID="radByAllIntersects" runat="server" GroupName="report" Text="تقاطعات كل الطرق الرئيسية"
                        AutoPostBack="True" OnCheckedChanged="radByAllIntersects_CheckedChanged" />
                </b>
            </td>
            <td>
                &nbsp;
