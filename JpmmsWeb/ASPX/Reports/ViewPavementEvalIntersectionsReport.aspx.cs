...
public partial class ASPX_Reports_ViewPavementEvalIntersectionsReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                string rptFullPath = "";
                if (Session["option"].ToString() == "radByIntersect")
                    rptFullPath = Server.MapPath(@".\RptFiles\UDI\JPMMS_VsamIntSec_UDI.RPT");
                else if (Session["option"].ToString() == "radbyStreet")
                    rptFullPath = Server.MapPath(@".\RptFiles\UDI\rptIntersectUDI.rpt");  // JPMMS_VMIDIntSecSam_UDI
                else if (Session["option"].ToString() == "radByIntersectWithDistress")
                    rptFullPath = Server.MapPath(@".\RptFiles\UDI\rptIntersectSamplesUdiDistresses.RPT");
                else
