...
public partial class ASPX_Reports_ViewAssets : System.Web.UI.Page
{
        ...
        try
        {
            if (Session["ReportData"] != null && Session["option"] != null)
            {
                ...
                if (Session["option"].ToString() == "radByMainLanes")
                    rptFullPath = Server.MapPath(@".\RptFiles\Operations\CrystalReport.rpt");
                else
            ...
            else if (Session["ReportDataDs"] != null && Session["option"] != null)
            {
                string rptFullPath = "";
                if (Session["option"].ToString() == "radByMainLanes")
                    rptFullPath = Server.MapPath(@".\RptFiles\Operations\CrystalReport.rpt");
                ...
                DataSet ds = (DataSet)Session["ReportDataDs"];
                ReportDocument rpt = new ReportDocument();
                ...
                Response.Redirect("AssetsReport.aspx", false);
