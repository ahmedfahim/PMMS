...
public partial class ASPX_Reports_ViewWorkOrders : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                string rptFullPath = "";
                if (Session["option"].ToString() == "WorkOrders")
                    rptFullPath = Server.MapPath(@".\RptFiles\Operations\rptWorkOrders.rpt");
                else
                ...
                Response.Redirect("WorkOrders.aspx", false);
