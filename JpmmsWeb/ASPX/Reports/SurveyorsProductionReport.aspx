...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="style1">
        ...
        <tr>
            ...
            <td>
                <asp:RadioButton ID="radSection" runat="server" Visible="false" GroupName="type" Text="مقاطع" />
                <br />
                <asp:RadioButton ID="radIntersection" runat="server" Enabled="false" GroupName="type" Text="تقاطعات" />
                <br />
                <asp:RadioButton ID="radRegionSecondary" runat="server"  Checked="True" GroupName="type" Text="مناطق شوارع فرعية" />
                <br />
                <asp:RadioButton ID="radTotal" runat="server" Enabled="false" GroupName="type" Text="إجمالي تسليم المساحين" />
            </td>
            <td>
                &nbsp;
            </td>
