            ...
            <td colspan="3">
                <table class="style1">
                        ...
                        <td colspan="2">
                            <strong>
                                <asp:RadioButton ID="radByStreetDistressAreaTotal" runat="server" AutoPostBack="True"
                                    ...
                                    Text="مساحة العيوب لشارع محدد (مجموع)" Visible="False" />
                            </strong>
                        </td>
                        <td>
                            &nbsp;
                    ...
                    <tr>
                        ...
                        <td>
                            <strong>
                                <asp:RadioButton ID="radByStreetAreaTotal" runat="server" 
                                AutoPostBack="True" GroupName="report"
                                    OnCheckedChanged="radByStreetAreaTotal_CheckedChanged" 
                                Text="المساحة - العيوب (مجموع)" Visible="False" />
                            </strong>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:RadioButton ID="radByDate" runat="server" AutoPostBack="True" GroupName="report" Visible="false"
             ...
             <%--               رمز العيب--%>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlDistresses" runat="server" AppendDataBoundItems="True" DataSourceID="odsDistresses"
                                ...
                                OnSelectedIndexChanged="ddlDistresses_SelectedIndexChanged" Visible="False">
                        ...
                        <td>
                            <b>
                                <asp:RadioButton ID="radSectionsSurroundingRegion" runat="server" AutoPostBack="True"
                                    ...
                                    Text="المقاطع المحيطة بالمنطقة " Visible="False" />
                            </b>
                        </td>
                        <td>
                            <telerik:RadComboBox Filter="Contains" Width="200px" Font-Size="Medium" AutoselectFirstItem="true"
                    ...
                    <tr>
                        ...
                        <td>
                            <telerik:RadComboBox Filter="Contains" Width="200px" Font-Size="Medium" AutoselectFirstItem="True"
                                ...
                                DataSourceID="odsSubMunicipality" DataTextField="munic_name" 
                                DataValueField="MUNIC_NO" Visible="False">
                                <Items>
                                    <telerik:RadComboBoxItem runat="server" Selected="True" Text="اختيار" Value="0" />
                                </Items>
                            </telerik:RadComboBox>
