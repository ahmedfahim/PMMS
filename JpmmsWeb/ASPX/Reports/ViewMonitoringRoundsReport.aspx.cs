...
public partial class ASPX_Reports_ViewMonitoringRoundsReport : System.Web.UI.Page
{
        ...
        try
        {
            if (Session["ReportData"] != null && Session["option"] != null)
            {
                ...
                if (Session["option"].ToString() == "radByMainLanes")
                    rptFullPath = Server.MapPath(@".\RptFiles\Operations\rptMonitoringSectionSamples.rpt");
                else if (Session["option"].ToString() == "radByIntersections")
                    rptFullPath = Server.MapPath(@".\RptFiles\Operations\rptMonitoringIntersection.rpt");
                    ...
                    rptFullPath = Server.MapPath(@".\RptFiles\Operations\rptMonitoringSecondarySt.rpt");
                else
