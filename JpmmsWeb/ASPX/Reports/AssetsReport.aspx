<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master" AutoEventWireup="true" CodeFile="AssetsReport.aspx.cs" Inherits="ASPX_Reports_AssetsReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="style1">
        <tr>
            ...
            <td class="style2">
                <h2>
                    <strong>تقرير أصول الطرق الرئيسية</strong></h2>
            </td>
            <td>
                &nbsp;
            </td>
        ...
        <tr>
            ...
            <td>
                <asp:ObjectDataSource ID="odsMainStreets" runat="server" SelectMethod="GetStreetsAssets"
