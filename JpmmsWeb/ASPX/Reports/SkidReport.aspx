<%@ Page Title="تقرير نتائج اختبارات مقاومة الانزلاق" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master"
    AutoEventWireup="true" CodeFile="SkidReport.aspx.cs" Inherits="ASPX_Reports_SkidReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="style1">
        <tr>
            ...
            <td class="style2">
                <h2>
                    <strong>تقرير نتائج اختبارات مقاومة الانزلاق</strong></h2>
            </td>
            <td>
                &nbsp;
            </td>
        ...
        <tr>
            ...
            <td>
                <asp:ObjectDataSource ID="odsMainStreets" runat="server" SelectMethod="GetStreetsSKID"
        ...
        <tr>
            ...
            <td>
                <telerik:RadComboBox Filter="Contains" Width="200px" Font-Size="Medium" AutoselectFirstItem="true"
                    ...
                    DataSourceID="odsMainStreets" DataTextField="main_no" 
            ...
            <td>
                <b>
                    <asp:RadioButton ID="radByIntersections" runat="server" GroupName="report" Text="تقاطعات شارع محدد"
                        AutoPostBack="True" OnCheckedChanged="radByIntersections_CheckedChanged" Visible="false"/>
                </b>
            </td>
            <td>
                &nbsp;
            ...
            <td>
                <b>
                    <asp:RadioButton ID="radByAllIntersections" runat="server" GroupName="report" Text="تقاطعات كل الطرق الرئيسية"
                        AutoPostBack="True" OnCheckedChanged="radByAllIntersections_CheckedChanged" Visible="false" />
                </b>
            </td>
            <td>
                &nbsp;
