...
public partial class ASPX_Reports_ViewCostingMaintDecisionsReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                string rptFullPath = Server.MapPath(@".\RptFiles\MD_Prio_cost\rptMaintDecisionsCosting.rpt");
                ...
                Response.Redirect("CostingMaintDecisionsReport.aspx", false);
