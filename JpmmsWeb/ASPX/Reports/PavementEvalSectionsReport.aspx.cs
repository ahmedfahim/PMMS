        ...
        try
        {
            ...
            if (radBySamples.Checked)
            {
                if (chkWithDistresses.Checked)
                {
                    ...
                    {
                        DataTable dt = new SectionsUDI().GetSamplesUdiWithDistresses(int.Parse(ddlMainStreets.SelectedValue), false, radAllDists.Checked, RadioButtonList1.SelectedValue);
                        if (dt.Rows.Count > 0)
                        {
                    ...
                    {
                        DataTable dt = new SectionsUDI().GetSamplesUdiWithDistresses(int.Parse(ddlMainStreetSection.SelectedValue), true, radAllDists.Checked, RadioButtonList1.SelectedValue);
                        if (dt.Rows.Count > 0)
                        if (dt.Rows.Count > 0)
                        {
                ...
                else
                {
                    if (ddlMainStreetSection.SelectedValue == "0")
                    {
                        DataTable dt = new SectionsUDI().GetSamplesUdiByMainStreet(int.Parse(ddlMainStreets.SelectedValue), radAllDists.Checked, RadioButtonList1.SelectedValue);
                        if (dt.Rows.Count > 0)
                        {
