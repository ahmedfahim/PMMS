<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master"
    AutoEventWireup="true" CodeFile="SurveyingReport.aspx.cs" Inherits="ASPX_Archive_SurveyingReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="style1">
        <tr>
            ...
            <td class="style2">
                <h2>
                    <b>تقرير الشوارع الممسوحة جاري العمل عليها</b></h2>
            </td>
            <td>
                &nbsp;
            </td>
        ...
        <tr>
            ...
            <td>
                <asp:RadioButtonList ID="RadioButtonList1" runat="server">
                    <asp:ListItem Selected="True" Value="3">المسح الثالث مناطق</asp:ListItem>
