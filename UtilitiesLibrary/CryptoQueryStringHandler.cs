...
namespace UtilitiesLibrary
{
    ...
    public static class CryptoQueryStringHandler
    {
        ...
        public static string EncryptQueryStrings(string[] unencryptedStrings, string key)
        {
            ...
            return string.Concat("request=", UtilitiesLibrary.Security.Encryption64.Encrypt(strings.ToString(), key));
        }
        ...
        {
            return UtilitiesLibrary.Security.Encryption64.Decrypt(encryptedStrings.Replace(" ", "+"), key);
        }
    }
}