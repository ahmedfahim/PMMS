...
<table class="style1">
    <tr>
        <td width="20%">
            <asp:RadioButton ID="radByNumber" runat="server" GroupName="search" Text="رقم التقاطع" />
        </td>
        <td rowspan="2">
    ...
    <tr>
        <td>
            <asp:RadioButton ID="radByName" runat="server" Width="120px" Checked="True" GroupName="search"
                Text="وصف التقاطع" />
        </td>
    </tr>
    <tr>
