<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master"
    AutoEventWireup="true" CodeFile="EditBridge.aspx.cs" Inherits="ASPX_Intersections_EditBridge" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="style1">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtBridgeNo" runat="server" Width="120px" MaxLength="3"></asp:TextBox>
            </td>
            <td>
                &nbsp;
            </td>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtBridgeName" runat="server" Width="339px"></asp:TextBox>
            </td>
            <td>
                &nbsp;
            </td>
            ...
            <td>
                <table class="style1">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <asp:CheckBox ID="chkCurved" runat="server" Text="الجسر منحني؟" CssClass="style12" />
                        </td>
                        <td colspan="2">
                            <b>&nbsp; </b>
                        </td>
                        <td>
                            <asp:CheckBox ID="chkPerpend" runat="server" Text="الجسر متعامد مع الطريق؟" CssClass="style12" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td colspan="6">
                            <table align="center" class="style15">
                                <tr>
                                    <td class="style13" style="direction: ltr">
                                        <b>X</b>
                                    </td>
                                    <td class="style2">
                                        <b>Y </b>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtDetails" runat="server" Height="76px" Width="520px" TextMode="MultiLine"></asp:TextBox>
            </td>
            <td>
                &nbsp;
            </td>
            ...
            <td colspan="3">
                <asp:GridView ID="gvBridges" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="BRIDGE_ID" DataNavigateUrlFormatString="EditBridge?id={0}"
