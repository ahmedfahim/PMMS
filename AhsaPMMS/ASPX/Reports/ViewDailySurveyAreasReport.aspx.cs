...
public partial class ASPX_Reports_ViewDailySurveyAreasReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                string rptFullPath = Server.MapPath(@".\RptFiles\FinishedSurveying\rptDailyFinishedAreas.rpt");
                ...
                Response.Redirect("DailyEntryReport.aspx", false);
