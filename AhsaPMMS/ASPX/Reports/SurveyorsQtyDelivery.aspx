<%@ Page Title="تقرير إنتاجية المساحين" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master"
    AutoEventWireup="true" CodeFile="SurveyorsQtyDelivery.aspx.cs" Inherits="ASPX_Reports_SurveyorsQtyDelivery" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="style1">
        <tr>
            ...
            <td class="style2">
                <h2>
                    <strong>تقرير إنتاجية المساحين (الكمية - التاريخ - التسليم)</strong></h2>
            </td>
            <td>
                &nbsp;
            </td>
        ...
        <tr>
            ...
            <td>
                <telerik:RadDatePicker ID="raddtpFrom" runat="server" AutoPostBack="True">
                ...
                إلى
                <telerik:RadDatePicker ID="raddtpTo" runat="server" AutoPostBack="True">
                    <Calendar UseRowHeadersAsSelectors="False" UseColumnHeadersAsSelectors="False" ViewSelectorText="x">
                    </Calendar>
                    <DateInput AutoPostBack="True">
                    </DateInput>
