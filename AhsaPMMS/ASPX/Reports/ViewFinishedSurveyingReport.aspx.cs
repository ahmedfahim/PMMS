        ...
        try
        {
            if (Session["ReportData"] != null && Session["option"] != null)
            {
                ...
                if (Session["option"].ToString() == "section" || Session["option"].ToString() == "intersect" || Session["option"].ToString() == "sectionPhotos"
                    || Session["option"].ToString() == "sectionQc" || Session["option"].ToString() == "radFwd" || Session["option"].ToString() == "radIriSections"
                    || Session["option"].ToString() == "radIntersectIri" || Session["option"].ToString() == "radGprSections" || Session["option"].ToString() == "radGprIntersect"
                    || Session["option"].ToString() == "radSkidSections" || Session["option"].ToString() == "radSkidIntersects" || Session["option"].ToString() == "radRuttingIntersects"
                    || Session["option"].ToString() == "radRuttingSections")
