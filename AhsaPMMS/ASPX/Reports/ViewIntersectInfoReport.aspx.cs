...
public partial class ASPX_Reports_ViewIntersectInfoReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                string rptFullPath = Server.MapPath(@".\RptFiles\Descriptive\rptIntersectionInfo.rpt");
