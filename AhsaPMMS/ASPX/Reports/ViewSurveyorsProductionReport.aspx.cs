...
public partial class ASPX_Reports_ViewSurveyorsProductionReport : System.Web.UI.Page
{
        ...
        try
        {
            if (Session["ReportData"] != null && Session["option"] != null)
            {
                ...
                if (Session["option"].ToString() == "radSection")
                    rptFullPath = Server.MapPath(@".\RptFiles\Surveyors\jpmms_Rpt_Surveyor_Sections.RPT");
                else if (Session["option"].ToString() == "radIntersection")
                    rptFullPath = Server.MapPath(@".\RptFiles\Surveyors\jpmms_Rpt_Surveyor_INTERSECTIONs.RPT");
                else if (Session["option"].ToString() == "radRegionSecondary")
                    rptFullPath = Server.MapPath(@".\RptFiles\Surveyors\JPMMS_Rpt_Surveyor_Regions.RPT");
                else
                ...
                Response.Redirect("SurveyorsLateWorkReport.aspx", false);
