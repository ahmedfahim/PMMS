...
public partial class ASPX_Reports_ViewSurveyorsNotesReport : System.Web.UI.Page
{
        ...
        try
        {
            if (Session["ReportData"] != null && Session["option"] != null)
            {
                ...
                if (Session["option"].ToString() == "radSection")
                    rptFullPath = Server.MapPath(@".\RptFiles\Surveyors\jpmms_Rpt_Sec_Qun_Req_Note.RPT");
                else if (Session["option"].ToString() == "radIntersection")
                    rptFullPath = Server.MapPath(@".\RptFiles\Surveyors\JPMMS_Rpt_Intsec_Qun_Req_Note.RPT");
                else if (Session["option"].ToString() == "radRegionSecondary")
                    rptFullPath = Server.MapPath(@".\RptFiles\Surveyors\JPMMS_Rpt_secST_Qun_Req_Note.RPT");
                else
                ...
                Response.Redirect("SurveyorsNotesReport.aspx", false);
