...
public partial class ASPX_Reports_ViewSecondaryStInfoReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                string rptFullPath = Server.MapPath(@".\RptFiles\Descriptive\rptSecondaryStInfo.rpt");
