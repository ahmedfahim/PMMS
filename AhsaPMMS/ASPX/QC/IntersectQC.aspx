<%@ Page Title="ضبط الجودة لمسوحات تقاطعات الشوارع الرئيسية" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master"
    AutoEventWireup="true" CodeFile="IntersectQC.aspx.cs" Inherits="ASPX_QC_IntersectQC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="style1">
        <tr>
            ...
            <td colspan="2">
                <h2 class="style2">
                    <b>ضبط الجودة لمسوحات تقاطعات الشوارع الرئيسية</b></h2>
            </td>
            <td>
                &nbsp;
            </td>
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <asp:ObjectDataSource ID="odsIntersectionSamples" runat="server" SelectMethod="GetIntersectionSamples"
                    TypeName="JpmmsClasses.BL.IntersectionSamples" UpdateMethod="UpdateIntersectionSampleArea">
                    <UpdateParameters>
                    ...
                    <SelectParameters>
                        <asp:ControlParameter ControlID="ddlIntersects" Name="intersectionID" PropertyName="SelectedValue"
                            Type="Int32" />
                    </SelectParameters>
                    ...
                    <table width="80%">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:LinkButton ID="lbtnSearch" runat="server" OnClick="lbtnSearch_Click" ToolTip="بحث متقدم بجزء من اسم أو رقم التقاطع">بحث متقدم </asp:LinkButton>
                            </td>
                            <td>
                                &nbsp;
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadComboBox Filter="Contains" Width="200px" Font-Size="Medium" AutoselectFirstItem="true"
                                    ID="ddlIntersects" runat="server" AppendDataBoundItems="True" AutoPostBack="True"
                                    DataSourceID="odsMainStreetIntersections" DataTextField="intersection_title"
                                    DataValueField="intersection_id" OnSelectedIndexChanged="ddlIntersects_SelectedIndexChanged">
                                    <Items>
                                        <telerik:RadComboBoxItem runat="server" Selected="True" Text="اختيار" Value="0" />
                                    </Items>
                                </telerik:RadComboBox>
                            ...
                            <td>
                                <asp:CompareValidator ID="CompareValidator5" runat="server" ControlToValidate="ddlIntersects"
                                    ErrorMessage="الرجاء اختيار التقاطع" Operator="NotEqual" ValidationGroup="insert"
                                    ValueToCompare="0"></asp:CompareValidator>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblIntersectAreaSum" runat="server"></asp:Label>
                            </td>
                            <td>
                                &nbsp;
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlSamples" runat="server" AppendDataBoundItems="True" AutoPostBack="True"
                                    DataSourceID="odsIntersectionSamples" DataTextField="INTER_SAMP_NO" DataValueField="INTER_SAMP_ID">
        ...
        <tr>
            <td colspan="3">
                ...
                <asp:GridView ID="gvQChecks" runat="server" DataSourceID="odsQChecks" AllowPaging="True"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="MAIN_TITLE" HeaderText="الشارع الرئيسي" SortExpression="MAIN_TITLE"
                            ReadOnly="True" />
                        <asp:BoundField DataField="INTERSECT_TITLE" HeaderText="التقاطع" SortExpression="INTERSECT_TITLE"
                            ReadOnly="True" />
                        <asp:BoundField DataField="INTER_SAMP_NO" HeaderText="العينة" SortExpression="INTER_SAMP_NO"
                            ReadOnly="True" />
                ...
                <asp:ObjectDataSource ID="odsQChecks" runat="server" DeleteMethod="Delete" SelectMethod="GetAllIntersectionsQChecks"
                    TypeName="JpmmsClasses.BL.QcCheck" OnDeleted="odsQChecks_Deleted" OnUpdated="odsQChecks_Updated"
                    UpdateMethod="UpdateIntersectQcCheckRecord">
                    <DeleteParameters>
                        <asp:Parameter Name="QC_CHECK_ID" Type="Int32" />
                    </DeleteParameters>
                    <SelectParameters>
                        <asp:Parameter DefaultValue="0" Name="intersectID" Type="Int32" />
                            ...
                            <tr>
                                <td colspan="2">
                                    <%-- <asp:LinkButton ID="lnkRemoveDistress" CommandArgument='<%# Bind("QC_CHECK_ID") %>'
                                        ...
                                        runat="server" OnClick="lnkRemoveDistress_Click">حذف عيوب جميع عينات التقاطع</asp:LinkButton>--%>
                                </td>
                            </tr>
                        </table>
                    </ItemTemplate>
