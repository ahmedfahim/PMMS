...
public partial class ASPX_Sections_ViewSectionMaintenancePrioritiesReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                string rptFullPath = Server.MapPath(@"..\Reports\RptFiles\MD_Prio_cost\rptSectionsMaintenanceDecision.rpt");
                ...
                Response.Redirect("SectionMaintenancePriorities.aspx", false);
