...
public partial class ASPX_Sections_Tunnels : System.Web.UI.Page
{
    ...
    protected void UpdateButton_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            bool saved = new Tunnel().Insert(txtBridgeName.Text, int.Parse(Request.QueryString["sectionID"]), 0, txtDetails.Text, ChkMidIsland.Checked, ChkSideWalk.Checked,
                ...
                ChkDrinage_CBs.Checked, chkDrainCbGood.Checked, int.Parse(ddlContractors.SelectedValue), txtTunnelNo.Text, Session["UserName"].ToString(), int.Parse(ddlBridgeType.SelectedValue), int.Parse(ddlCammerTypes.SelectedValue),
    ...
    {
        string url = string.Format("Tunnels.aspx?sectionID={0}", Request.QueryString["sectionID"]);
