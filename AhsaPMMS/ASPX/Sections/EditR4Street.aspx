<%@ Page Title="تعديل بيانات الطرق والشوارع المستحدثة" Language="C#" MasterPageFile="~/MasterPage/ServicesHome.master"
    AutoEventWireup="true" CodeFile="EditR4Street.aspx.cs" Inherits="ASPX_Sections_EditR4Street" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="style1">
        <tr>
            ...
            <td class="style2">
                <strong>تعديل بيانات الطرق والشوارع المستحدثة</strong>
            </td>
            <td>
                &nbsp;
            </td>
                                                            ...
                                                            <tr>
                                                                <td class="style12" colspan="4">
                                                                    <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="ddlContractors"
                                                                        ErrorMessage="الرجاء اختيار مقاول التنفيذ" Operator="NotEqual" Style="font-size: small;
                                                                        font-weight: 700" ValueToCompare="0"></asp:CompareValidator>
                                                                </td>
                                                                <td class="style14" colspan="2">
