...
public partial class ASPX_Sections_ViewDistressImage : System.Web.UI.Page
{
    ...
    {
        string url = string.Format("SectionDistresses.aspx?DistID={0}", Request.QueryString["DistID"]);
