        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            if (Visible)
            {
                ...
                if (Items.Count > 0 && Enabled)
                {
                    ...
                    string css = string.Format(@"class=""ui-widget ui-widget-content ui-corner-left{0}""", (string.IsNullOrEmpty(CssClass)) ? string.Empty : string.Format(@" {0}", CssClass));
                ...
                {
                    // Standard Text Box
                    string css = string.Format(@"class=""ui-widget ui-widget-content ui-corner-left ui-corner-right{0}""", (string.IsNullOrEmpty(CssClass)) ? string.Empty : string.Format(@" {0}", CssClass));
