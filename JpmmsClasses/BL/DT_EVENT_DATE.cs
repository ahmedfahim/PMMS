...
namespace JpmmsClasses.BL
{
    ...
    public class DT_EVENT_DATEComparer : IEqualityComparer<DT_EVENT_DATE>
    {
        public bool Equals(DT_EVENT_DATE x, DT_EVENT_DATE y)
        {
        ...
        public int GetHashCode(DT_EVENT_DATE obj)
        {
