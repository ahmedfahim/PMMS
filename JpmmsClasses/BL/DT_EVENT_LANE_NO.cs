...
namespace JpmmsClasses.BL
{
    ...
    public class DT_EVENT_LANE_NOComparer : IEqualityComparer<DT_EVENT_LANE_NO>
    {
        public bool Equals(DT_EVENT_LANE_NO x, DT_EVENT_LANE_NO y)
        {
        ...
        public int GetHashCode(DT_EVENT_LANE_NO obj)
        {
