...
{
    public class DT_EVENT_LANE_WIDTH
    {
        public string Survey_ID { get; set; }
        public string LANE_WIDTH { get; set; }
    ...
    public class DT_EVENT_LANE_WIDTHComparer : IEqualityComparer<DT_EVENT_LANE_WIDTH>
    {
        public bool Equals(DT_EVENT_LANE_WIDTH x, DT_EVENT_LANE_WIDTH y)
        {
        ...
        public int GetHashCode(DT_EVENT_LANE_WIDTH obj)
        {
